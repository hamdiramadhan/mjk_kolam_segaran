    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            @if (Auth::user()->role_id == 1)
                <a href="{{ route('create_master_sub_opd') }}" class="btn waves-effect btn-primary btn-md">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered key-buttons border-bottom datatable-basic-group-1">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($opds as $r)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td><b>{{ @$r->atasan->unit_id }} {{ @$r->atasan->unit_name }}</b></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex p-2 txt-bold">
                                                ...
                                                ?>
                                                <a href="{{ route('edit_master_sub_opd', $key) }}" class="btn btn-outline-primary"><i class='bx bx-edit me-0'></i>
                                                </a>
                                                @if (Auth::user()->role_id == 1)
