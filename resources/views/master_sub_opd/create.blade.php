...
@endphp 
    <div class="breadcrumb-header justify-content-between mg-lg-t-0  ">
        <div class="left-content">
            <h4 class="content-title mb-1">Tambah Data {{ @$nama_header }}</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Master</li>
                    <li class="breadcrumb-item active" aria-current="page">{{ @$nama_header }}</li>
                    <li class="breadcrumb-item active" aria-current="page">Tambah {{ @$nama_header }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="col-md-12 col-xl-12"> 
            ...
            <div class="card-body">
                <form method="POST" class="form-horizontal" action="{{ route('simpan_tambah_sub_opd') }}">
                    @csrf
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <select class="select22" name="induk" style="width: 100%" required>
                                ...
                                <option value="{{ $o->id }}">{{ $o->unit_id }} {{ $o->unit_name }}</option>
                                @endforeach
                            </select> 
                        </div>
                    </div> 
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" required class="form-control" id="unit_id" name="unit_id" placeholder="Contoh : 1.01.01" autocomplete="Nama">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="unit_id_sidirga" name="unit_id_sidirga" placeholder="Kode SKPD di aplikasi SIDIRGA" autocomplete="Nama">
                        </div>
                    </div> 
                    @endif 
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input required type="text" placeholder="Nama SKPD" class="form-control" name="unit_name" id="unit_name">

                        </div>
                    </div>

                    <div class=" row mb-4">
                        <label for="nama" class="col-md-3 form-label">Kepala Nama</label>
                        <div class="col-md-9">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="number" min="0" placeholder="Kepala NIP" class="form-control" name="kepala_nip"
                                id="kepala_nip">
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="number" min="0" placeholder="Telp" class="form-control" name="telp"
                                id="telp">
                        </div>
                    </div>
                    ...
                    <div class=" row mb-4">
                        ...
                        <div class="col-md-9">
                            <input type="number" min="0" placeholder="Fax" class="form-control" name="fax" id="fax">
                        </div>
                    </div>
