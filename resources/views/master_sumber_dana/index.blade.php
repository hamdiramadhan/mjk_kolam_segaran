...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            ...
            <a href="{{ route('sumber_dana.create') }}" type="button" class="btn btn-primary px-5"><i
                    ...
                    <tbody>
                        ...
                        @foreach ($sumber_dana as $r)
                            ...
                            <tr>
                                ...
                                <td>{{ $r->keterangan }}</td>
                                <td>
                                    <a href="{{ route('sumber_dana.edit', encrypt($r->id)) }}" type="button"
                                    ...
                                    <form method="POST" onsubmit="return confirm('Anda yakin menghapus data ini ??')"
                                        action="{{ route('sumber_dana.destroy', encrypt($r->id)) }}">
                                        @csrf
